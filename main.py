...
MAX_POSTS_PER_CYCLE = 3  # Теперь будет публиковать до 3 новых постов за запуск
    ...
    for feed_url in RSS_FEEDS:
        ...
        try:
            ...
            for entry in feed.entries[:10]:
                ...
                if link in seen:
                    print(f"      ⏭️  Уже опубликовано (есть в памяти)")
                    print(f"         Ссылка: {link[:70]}")
                    continue
